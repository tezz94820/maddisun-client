  ...
  return (
    <div>
      ...
      <section className="px-4 mt-5">
        ...
        <div className="flex flex-row gap-2 mt-3">
          <Link href="/admin/blogs/all-products" className="hover:bg-[#FFA943] hover:text-white border-2 border-[#FFA943] rounded-lg px-4 py-2 cursor-pointer transation-all duration-300" >Get All Blogs</Link>
