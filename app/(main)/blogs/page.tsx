...
export default function Blogs() {
    ...
    return (
        <div className="relative flex flex-col items-center w-full overflow-hidden">
            ...
            {/* categories section */}
            <div className="h-fit w-full px-10 py-5 md:px-8 lg:px-10 md:py-10 flex gap-[3rem] flex-row flex-wrap justify-evenly bg-[radial-gradient(circle_at_left,_#DCF5EC_0%,_transparent_50%)]">
                {
